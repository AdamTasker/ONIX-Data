...
namespace OnixData.Legacy.Lists
{
  ...
  public enum OnixList7
  {
    ...
    [XmlEnum("DC")] CdI,
    /// <summary>
    /// DEPRECATED – use <see cref="DvdVideo"/> for DVD video, <see cref="DvdAudio"/> for DVD audio, <see cref="DvdRom"/> for DVD-ROM
    /// </summary>
    [XmlEnum("DD")] Dvd,
    ...
    /// </summary>
    [XmlEnum("DO")] DigitalProductLicenseKey,
    /// <summary>
    /// Other carrier of digital content not specified by <see cref="CdRom"/> to <see cref="DigitalProductLicenseKey"/>
    /// </summary>
    ...
    /// <summary>
    /// Continuous film or filmstrip: DEPRECATED – use <see cref="Filmstrip"/> or <see cref="Film"/>
    /// </summary>
    [XmlEnum("FB")] FilmOrFilmstrip,
    /// <summary>
    ...
    /// </summary>
    [XmlEnum("LB")] DigitalProductLicenseKey2,
    /// <summary>
    ...
    [XmlEnum("VA")] Video,
    /// <summary>
    /// DEPRECATED – use new <see cref="VhsVideo"/>
    /// </summary>
    [XmlEnum("VB")] VideoVhsPal,
    /// <summary>
    /// DEPRECATED – use new <see cref="VhsVideo"/>
    /// </summary>
    [XmlEnum("VC")] VideoVhsNtsc,
    /// <summary>
    /// DEPRECATED – use new <see cref="BetamaxVideo"/>
    /// </summary>
    [XmlEnum("VD")] VideoBetamaxPal,
    /// <summary>
    /// DEPRECATED – use new <see cref="BetamaxVideo"/>
    /// </summary>
    [XmlEnum("VE")] VideoBetamaxNtsc,
    /// <summary>
    /// eg Laserdisc
    /// </summary>
    ...
    /// DEPRECATED – use new <see cref="VhsVideo"/>
    /// </summary>
    [XmlEnum("VG")] VideoVhsSecam,
    /// <summary>
    /// DEPRECATED – use new <see cref="BetamaxVideo"/>
    /// </summary>
    [XmlEnum("VH")] VideoBetamaxSecam,
    /// <summary>
    ...
    /// </summary>
    [XmlEnum("WW")] MixedMediaProduct,
    /// <summary>
    ///   <para>
    ///     A product containing multiple copies of one or more items packaged together for retail sale, consisting of either:<br/>
    ///       (a) Several copies of a single item (eg 6 copies of a graded reader)<br/>
    ///       (b) Several copies of each of several items (eg 3 copies each of 3 different graded readers)<br/>
    ///       (c) Several copies of one or more single items plus a single copy of one or more related items (eg 30 copies of a pupil’s textbook plus 1 of teacher’s text)<br/>
    ///   </para>
    ///   <br/>
    ///   <para>
    ///     NOT TO BE CONFUSED WITH:<br/>
    ///       Multi-volume sets, or sets containing a single copy of a number of different items (boxed, slip-cased or otherwise)<br/>
    ///       Items with several components of different physical forms (see <see cref="MixedMediaProduct"/>)<br/>
    ///       Packs intended for trade distribution only, where the contents are retailed separately (see <see cref="DumpbinFilled"/>, <see cref="CounterpackFilled"/>, <see cref="ShrinkWrappedPack"/>)
    ///   </para>
    /// </summary>
    [XmlEnum("WX")] MultipleCopyPack,
    /// <summary>
    ...
    /// <summary>
    /// A quantity pack with its own product code, for trade supply only: the retail items it contains are intended for sale individually – see also <seealso cref="MultipleCopyPack"/>. For products or product bundles supplied shrink-wrapped for retail sale, use the Product Form code of the contents plus code 21 from List 80
    /// </summary>
    [XmlEnum("XL")] ShrinkWrappedPack,
    /// <summary>
    /// A quantity pack with its own product code, for trade supply only: the retail items it contains are intended for sale individually – see also <seealso cref="MultipleCopyPack"/>. For products or product bundles supplied boxed for retail sale, use the Product Form code of the contents plus code 09 from List 80
    /// </summary>
    ...
    [XmlEnum("ZL")] ToteBag,
    /// <summary>
    /// Other apparel items not specified by <see cref="Doll"/> to <see cref="Jigsaw"/>, including promotional or branded scarves, caps, aprons etc
    /// </summary>
